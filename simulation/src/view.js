...
var ultrasonic_Interferometer_stage,
  exp_canvas,
  tick,
  currentMediumSelected_number;
...
var button_clickFlag,
  arrow_check = true;
var mediumColorArray = [
  "color_common",
  "color_common",
  "color_kerosene",
  "color_castorOil",
...
var gain_value,
  ...
  fixed_adjsValue,
  vernier_clicks,
  vernier_clicks_forZoom,
  vernier_clicks_device_Front,
  curren_Frequency_Glb;
...
var comprasabilityArry = [4.4, 4.81, 6, 4.81, 2.2];
...
function directiveFunction() {
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      zoomScale_view_container =
        new createjs.Container(); /** Creating the zoomout view container */
      zoomScale_view_container.name = "zoomScale_view_container";
      ultrasonic_Interferometer_stage.addChild(
        zoomScale_view_container,
      ...
      function handleComplete() {
        loadImages(
          ...
          "",
          0,
          ultrasonic_Interferometer_stage,
        );

        loadImages(
          queue.getResult("device_Back"),
          "device_Back",
          0,
          0,
          1,
        ...
        loadImages(
          queue.getResult("color_kerosene"),
          "color_kerosene",
          98.2,
          432,
          0.34,
        ...
        loadImages(
          queue.getResult("color_castorOil"),
          "color_castorOil",
          98.2,
          432,
          0.34,
        ...
        loadImages(
          queue.getResult("screw_Guage_Top"),
          "screw_Guage_Top",
          99,
          123,
          1,
        ...
        loadImages(
          queue.getResult("reading_Area_Top"),
          "reading_Area_Top",
          0,
          0,
          1,
        ...
        zoomed_view_of_vernier_mask.graphics.drawRect(170, 20, 150, 150)
          .command;
        ...
        getChild("main_right_arrow").addEventListener(
          "mousedown",
          function (evt) {
        ...
        getChild("main_left_arrow").addEventListener(
          "mousedown",
          function (evt) {
...
function getChild(child_name) {
  return ultrasonic_Interferometer_stage.getChildByName(
    child_name,
  ); /** Returns the child element of stage */
}
